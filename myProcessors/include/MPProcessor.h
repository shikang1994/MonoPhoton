#ifndef MPProcessor_h
#define MPProcessor_h 1
 ...
 *
 * @author F. Gaede, DESY
 * @version $Id: MPProcessor.h,v 1.4 2005-10-11 12:57:39 gaede Exp $
 */

class MPProcessor : public Processor {
    
public:
    
    virtual Processor*  newProcessor() { return new MPProcessor ; }
