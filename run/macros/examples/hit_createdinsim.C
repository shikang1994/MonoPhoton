...
void hit_createdinsim ()
{
  ...
  fnamexy << "$HOME/work/MonoPhoton/run/hists/example/hit_createdinsim/hit_xy_createdinsim.pdf" << ends;
  fnamerz << "$HOME/work/MonoPhoton/run/hists/example/hit_createdinsim/hit_rz_createdinsim.pdf" << ends;
