...
void mcinfo ()
{
  ...
  fnamee << "$HOME/work/MonoPhoton/run/hists/example/mcinfo/mcp_e.pdf" << ends;
  fnamephi << "$HOME/work/MonoPhoton/run/hists/example/mcinfo/mcp_phi.pdf" << ends;
  fnametheta << "$HOME/work/MonoPhoton/run/hists/example/mcinfo/mcp_theta.pdf" << ends;
  fnamepdg << "$HOME/work/MonoPhoton/run/hists/example/mcinfo/mcp_pdg.pdf" << ends;
